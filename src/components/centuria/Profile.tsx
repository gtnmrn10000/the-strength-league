    ...
    <div className="rounded-2xl border border-arena-border bg-arena-surface p-5">
      ...
      {hasPRs ? (
        ...
        <div className="rounded-xl bg-secondary p-4 text-center">
          ...
          <p className="mt-1 flex items-center justify-center gap-1 text-[10px] text-arena-sub">Publie ton premier record pour commencer <Dumbbell size={10} className="text-arena" /></p>
        </div>
      )}
