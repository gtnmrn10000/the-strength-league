...
const FAQ_ITEMS: { q: string; a: string }[] = [
  ...
  { q: "Que comprend l'abonnement Premium ?", a: "Le Coach conversationnel et le suivi avancé de progression. Le suivi de base reste gratuit." },
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-arena-sub">
                      {isPremium
                         ? "Accès complet au Coach et au suivi avancé"
                         : "Accède au Coach et au suivi avancé"}
                    </p>
                  </div>
                </div>
                {!isPremium && (
